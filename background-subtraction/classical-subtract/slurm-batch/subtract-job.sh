#!/bin/bash
#SBATCH -J subtract			       #The name of the job
...
#SBATCH --error=/lustre/isaac/scratch/tmengel/jet-background-subtraction/background-subtraction/classical-subtract/slurm-batch/slurm-err/subtract.e%J	     
#SBATCH --output=/lustre/isaac/scratch/tmengel/jet-background-subtraction/background-subtraction/classical-subtract/slurm-batch/slurm-out/subtract.o%J	     
#SBATCH --qos=condo

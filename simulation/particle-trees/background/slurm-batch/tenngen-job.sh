...
#SBATCH --error=/lustre/isaac/scratch/tmengel/jet-background-subtraction/simulation/particle-trees/background/slurm-batch/slurm-err/TGRHIC.e%J	     
#SBATCH --output=/lustre/isaac/scratch/tmengel/jet-background-subtraction/simulation/particle-trees/background/slurm-batch/slurm-out/TGRHIC.o%J	     
#SBATCH --qos=condo
